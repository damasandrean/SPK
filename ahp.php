...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a href="#" class="navbar-brand">Sisitem Pendukung Keputusan</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a href="#" class="nav-item nav-link active">Metode SAW</a>
                <a href="wp.php" class="nav-item nav-link">Metode WP</a>
                <a href="ahp.php" class="nav-item nav-link">Metode AHP</a>
                <a href="electree.php" class="nav-item nav-link">Metode ELECTREE</a>
            </div>
        </div>
    </nav>
    <br>
     <table class="table">
        ...
        <tbody>
            <th>DAMAS ANDREAN NUR WICAKSONO</th>
            <th>DIV Teknik Informatika 3C</th>
        </tbody>
    </table>
    <br>
    <br>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php $C2A2 = 2000000; echo $C2A2;?></td>
